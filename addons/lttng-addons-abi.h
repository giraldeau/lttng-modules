...
#define LTTNG_PROFILE_PROC "lttngprofile"
#define LTTNG_PROFILE_PATH "/proc/" LTTNG_PROFILE_PROC

enum lttng_profile_module_cmd {
  LTTNG_PROFILE_MODULE_REGISTER = 0,
  LTTNG_PROFILE_MODULE_UNREGISTER = 1,  
};

/*
 * Structure to send messages to the kernel module.
 */
struct lttng_profile_module_msg {
  int cmd;                 /* Command */
 ...
 */
#define LTTNG_PROFILE_MODULE_IOCTL  _IO(0xF6, 0x90)
